...
public class SampleObjects {
    public static void main(String[] args) throws IOException {
        ...
        dP1 = new Dependent("C1000000001", "FUBAO", new InsuranceCard("1100000001", "STARSHIP ENT", "2025/04/04", dP1), pH1);
        Dependent dP2 = new Dependent();
        dP2 = new Dependent("C1000000002", "AIBAO", new InsuranceCard("1100000002", "STARSHIP ENT", "2025/04/04", dP2), pH1);
        Dependent dP3 = new Dependent();
        dP3 = new Dependent("C1000000003", "LEBAO", new InsuranceCard("1100000003", "STARSHIP ENT", "2025/04/04", dP3), pH1);
        Dependent dP4 = new Dependent();
        dP4 = new Dependent("C5000000001", "HUIBAO", new InsuranceCard("1500000001", "STARSHIP ENT", "2025/04/04", dP4), pH5);
        Dependent dP5 = new Dependent();
        dP5 = new Dependent("C5000000002", "RUIBAO", new InsuranceCard("1500000002", "STARSHIP ENT", "2025/04/04", dP5), pH5);
